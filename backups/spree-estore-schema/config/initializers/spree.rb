Spree.config do |config|
  ...
  # Edit gem package file: spree_mail_settings-3.0.0/app/views/spree/admin/mail_methods/_form.html.erb
  # <%= text_field_tag :mails_from, Spree::Config[:mails_from], maxlength: 256, class: 'form-control' %>
  # <%= text_field_tag :mail_from_address, Spree::Store.current[:mail_from_address], maxlength: 256, class: 'form-control' %>
  #
...
SpreeI18n::Config.available_locales = [:uk, :en]
SpreeI18n::Config.supported_locales = [:uk, :en]
